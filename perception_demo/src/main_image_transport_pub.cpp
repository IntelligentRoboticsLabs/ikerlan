...
{
  // Create a logger
  rclcpp::Logger logger_ = rclcpp::get_logger("image_transport_publisher");
  ...
  node_->declare_parameter<std::string>("topic_image", "image_transport");
...
// ros2 run perception_demo main_image_transport_pub mario.jpg
